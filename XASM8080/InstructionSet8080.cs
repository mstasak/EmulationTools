...
internal static class InstructionSet8080 {
    private static readonly InstructionDefinition[] instructionSet = {
        ...
        new InstructionDefinition {Mnemonic = "MOV", Opcode = 0x40, OperandModel = OperandModel.R8LeftAndRight, IsPseudoOp = false},
        new InstructionDefinition {Mnemonic = "HLT", Opcode = 0x76, OperandModel = OperandModel.None, IsPseudoOp = false},
        new InstructionDefinition {Mnemonic = "ADD", Opcode = 0x80, OperandModel = OperandModel.R8Right, IsPseudoOp = false},
        new InstructionDefinition {Mnemonic = "ADC", Opcode = 0x88, OperandModel = OperandModel.R8Right, IsPseudoOp = false},
        new InstructionDefinition {Mnemonic = "SUB", Opcode = 0x90, OperandModel = OperandModel.R8Right, IsPseudoOp = false},
        new InstructionDefinition {Mnemonic = "SBB", Opcode = 0x98, OperandModel = OperandModel.R8Right, IsPseudoOp = false},
        new InstructionDefinition {Mnemonic = "ANA", Opcode = 0xA0, OperandModel = OperandModel.R8Right, IsPseudoOp = false},
        new InstructionDefinition {Mnemonic = "XRA", Opcode = 0xA8, OperandModel = OperandModel.R8Right, IsPseudoOp = false},
        new InstructionDefinition {Mnemonic = "ORA", Opcode = 0xB0, OperandModel = OperandModel.R8Right, IsPseudoOp = false},
        new InstructionDefinition {Mnemonic = "CMP", Opcode = 0xB8, OperandModel = OperandModel.R8Right, IsPseudoOp = false},
